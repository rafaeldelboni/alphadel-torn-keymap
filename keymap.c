...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 KC_LGUI,   MO(1),  KC_SPC,  KC_SPC,     KC_ENT,  KC_ENT,   MO(2), KC_LALT
                             //`-----------------------------------'  `-----------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, XXXXXXX, CEDILLA, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 KC_LGUI, _______,  KC_SPC,  KC_SPC,    KC_ENT,   KC_ENT,   MO(3), KC_LALT
                             //`-----------------------------------'  `-----------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 KC_LGUI,   MO(3),  KC_SPC,  KC_SPC,     KC_ENT,  KC_ENT, _______, KC_LALT
                             //`-----------------------------------'  `-----------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                   KC_P0, _______,  KC_SPC,  KC_SPC,     KC_ENT,  KC_ENT, _______, KC_LALT
                             //`-----------------------------------'  `-----------------------------------'
  )
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case CEDILLA:
        if (record->event.pressed) {
           SEND_STRING(SS_ALGR(",")); // selects all and copies
        }
        break;
    }
    return true;
